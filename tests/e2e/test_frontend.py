...
class TestFrontendE2E:
    ...
    def test_ui_elements_present(self, browser_context):
        ...
        buttons = [
            "#btn-connect", "#btn-start", "#btn-export", "#btn-export-batch",
            "#btn-peak-label", "#btn-theme", "#btn-baseline", "#btn-peak-area",
            "#btn-library-match", "#btn-import", "#btn-history-add",
            "#btn-history-clear", "#btn-multi-spectrum"
        ]
    ...
    def test_library_panel_exists(self, browser_context):
        ...
        expect(library_panel).to_be_attached()
